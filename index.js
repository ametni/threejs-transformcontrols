    ...
    if (_mode === "translate") {
      ...
      if (scope.space === "local") {
        ...
        if (scope.axis === "XYZ") {
          ...
          if (scope.axis === "X") scope.object.scale.x = oldScale.x * ( 1 + 0.1 * point.x / oldScale.x );
          if (scope.axis === "Y") scope.object.scale.y = oldScale.y * ( 1 + 0.1 * point.y / oldScale.y );
          if (scope.axis === "Z") scope.object.scale.z = oldScale.z * ( 1 + 0.1 * point.z / oldScale.z );
